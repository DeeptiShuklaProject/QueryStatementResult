...
#         for i in range(100):
#             level = fake.random.choice(levels)
#             query = self.generate_sql_query(level)
...
#         """
#         Generates an SQL query based on the difficulty level.
#         """
#         if level == 'easy':
#             return "SELECT * FROM employees;"  # Simple SELECT query for beginners
#         elif level == 'medium':
#             return "SELECT department, COUNT(*) FROM employees GROUP BY department;"  # Grouping data
#         elif level == 'hard':
#             return """
...
#             """  # Complex query with JOIN, subquery, and sorting
